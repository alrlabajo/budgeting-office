    ...
    <div class="left-[20px] top-[100px] absolute flex-col justify-start items-start gap-y-0 inline-flex">
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700 ml-72">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg w-44 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Timeline</button>
                </li>
                <li class="me-2" role="presentation">
        ...
        <div id="default-tab-content">
            <!--All-->
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ml-72 w-[1214px]" id="profile" role="tabpanel" aria-labelledby="profile-tab">
