    ...
    <div class="left-[20px] top-[100px] absolute flex-col justify-start items-start gap-y-0 inline-flex">
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700 ml-72">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 w-44" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Unread</button>
                </li>
            </ul>
        </div>
        <div id="default-tab-content">
            <div class="hidden p-4 rounded-lg ml-72 w-[1214px]" id="profile" role="tabpanel" aria-labelledby="all-tab">
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 ml-72" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <p class="text-sm text-gray-500 dark:text-gray-400">All <strong class="font-medium text-gray-800 dark:text-white">unread notifications</strong> are stored here.</p>
            </div>
        </div>
