...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        <!--Background Photo-->
            <img class="w-[1367px] h-screen left-[340px] top-[0px] fixed" src="{{ asset('css/images/img/background.png') }}"/>
            <!--Form Container-->
            <div class="w-[550px] h-[600px] left-[74px] top-[52px] absolute">
                    ...
                    <div class="w-96 h-96 left-[131.13px] top-[229.80px] absolute rounded-xl flex-col justify-start items-start gap-12 inline-flex">
                        ...
                        <div class="flex-col justify-start items-center gap-6 flex">
                            ...
                            <button type="submit" class="w-96 h-14 flex items-center justify-center bg-gray-200 rounded text-[#4B5768]">
                                <img class="w-6 h-7 left-[124.89px] top-[10px]" src="{{ asset('css/images/img/image 1.png') }}" />
                ...
                <div class="w-96 h-20 left-[60px] top-[20px] absolute">
                    <img class="w-20 h-20 left-1 top-1.5 absolute rounded-xl" src="{{ asset('css/images/img/image 5.png') }}" />
                    <img class="w-75 h-15 left-[93px] top-[17.48px] absolute" src="{{ asset('css/images/img/image 4.png') }}" />
                </div>
            </div>
        </div>
    </body>
