<aside x-data="{ open: false }" class="bg-white w-screen dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 z-50">
        ...
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center">
                <div class="relative">
                    ...
                    <input class="w-96 h-10 pl-10 py-1 bg-zinc-100 rounded-lg flex items-center grow shrink basis-0 text-neutral-700 text-base font-normal font-nunito leading-normal ml-2" placeholder="Search here"></input>
                </div>
            </div>
    ...
    <div class="w-64 h-full left-0 top-20 bg-[#2D349A] text-white flex flex-col items-center fixed">
        ...
        <a href="{{ route('dashboard') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito">Dashboard</div>
        </a>
        <!-- Profile Section -->
        <a href="{{ route('profile.edit') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito ">My Profile</div>
        </a>
        ...
        <a href="{{ route('notifications') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito">Notifications</div>
        </a>
        ...
        <a href="{{ route('workflow') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito">Workflow</div>
        </a>
        ...
        <a href="{{ route('files') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito">Files</div>
        </a>
        ...
        <button type="submit" class="w-56 mt-64 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
            ...
            <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-nunito">Settings</div>
        </button>
    </div>
    </div>
</aside>