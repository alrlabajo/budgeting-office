<nav x-data="{ open: false }" class="bg-white w-screen dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed top-0 z-50">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <img class="w-80 h-auto left-5 top-1 absolute" src="{{ asset('css/images/img/plm-logo--with-header 1.png') }}" />
                    </a>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48" style="position: absolute; top: -12rem; right: 0;">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="hover:bg-blue-600 hover:text-[#EFF0FF] active:bg-[#4F74BB] active:text-[#EFF0FF] rounded-md flex items-center justify-between stroke-[#71717A] hover:stroke-white"
    ...
    <!--Side Navigation-->
    <div class="w-64 h-full left-0 top-20 bg-[#2D349A] text-white flex flex-col items-center fixed">
        <div class="w-[228.12px] h-11 text-white text-[24px] font-semibold font-['Inter'] leading-9 ml-12 mt-4">Accounting</div>
            <!-- Dashboard Section -->
            <a href="{{ route('dashboard') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans'] ">Dashboard</div>
            </a>
            <!-- Profile Section -->
            <a href="{{ route('profile.edit') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans'] ">My Profile</div>
            </a>

             <!-- Notifications Section -->
            <a href="{{ route('notifications') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                <div class="w-9 h-9 rounded-md shadow justify-center items-center flex">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans'] ">Notifications</div>
            </a>

            <!-- Workflow Section -->
            <a href="{{ route('workflow') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                <div class="w-9 h-9 rounded-md shadow justify-center items-center flex">
                    <div class="w-5 h-5 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans'] ">Workflow</div>
            </a>

            <!-- Files Section -->
            <a href="{{ route('files') }}" class="w-56 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                <div class="w-9 h-9 rounded-md shadow justify-center items-center flex">
                    <div class="w-5 h-5 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans'] ">Files</div>
            </a>

            <!-- Settings Section -->
            <button type="submit" class="w-56 mt-64 px-4 py-2 flex items-center rounded-md hover:bg-[#2C56A6] active:bg-[#4F74BB]">
                <div class="w-9 h-9 rounded-md shadow justify-center items-center flex">
                    <div class="w-5 h-5 relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                ...
                <div class="text-white text-lg font-normal font-sans leading-7 ml-3 font-['Nunito Sans']">Settings</div>
            </button>
        </div>
    </div>
</nav>