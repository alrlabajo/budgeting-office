...
<x-app-layout>
    ...
    <label class="text-black text-2xl font-medium font-inter leading-9 ml-72 mt-3">Dashboard
        ...
        <div class="w-[382px] h-20 left-0 top-32 absolute">
            <div class="w-[382px] h-20 left-80 top-8 mb-32 absolute bg-white rounded-2xl shadow">
                <div class="w-32 h-11 left-[21.50px] top-[17.50px] absolute">
                    <div class="w-24 h- left-0 top-0 absolute text-slate-400 text-[12px] font-bold font-inter leading-tight">Today’s Money</div>
        ...
        <div class="w-[382px] h-20 left-80 top-32 absolute mx-4">
            <div class="w-[382px] h-20 left-96 top-8 absolute bg-white rounded-2xl shadow">
                <div class="w-32 h-11 left-[21.50px] top-[17.50px] absolute">
                    <div class="w-24 h- left-0 top-0 absolute text-slate-400 text-[12px] font-bold font-inter leading-tight">Today’s Users</div>
        ...
        <div class="w-[382px] h-20 left-80 top-32 absolute mx-8">
            <div class="w-[382px] h-20 left-96 top-8 absolute bg-white rounded-2xl shadow ml-96">
                <div class="w-32 h-11 left-[21.50px] top-[17.50px] absolute justify-center">
                    <div class="w-24 h- left-0 top-0 absolute text-slate-400 text-[12px] font-bold font-inter leading-tight">New Clients</div>
    ...
    <div class="flex gap-x-5 ml-80 mt-20">
