...
<x-app-layout>
    ...
    <!--Images-->
    <img class="w-[1451px] h-[113px] left-[255px] top-20 absolute" src="{{ asset('css/images/img/image 3.png') }}" />
    ...
    <!--Basic Info-->
    <label class="left-[800px] top-[485px] absolute text-black text-base font-normal font-inter leading-9">Name</label>
    <label class="left-[800px] top-[530px] absolute text-black text-base font-normal font-inter leading-9">Birthday</label>
    <label class="left-[800px] top-[575px] absolute text-black text-base font-normal font-inter leading-9">Gender</label>
    ...
    <!--Contact Info-->
    <label class="left-[800px] top-[715px] absolute text-black text-base font-normal font-inter leading-9">Email</label>
    <label class="left-[800px] top-[760px] absolute text-black text-base font-normal font-inter leading-9">Phone</label>
    ...
    <div class="w-[1367px] h-[1px] left-[317px] top-[835px] absolute border border-zinc-300"></div>
     ...
     <div class="w-80 left-[970px] top-[720px] absolute justify-start items-start inline-flex">{{ Auth::user()->email }}</div>
    <div class="w-80 left-[970px] top-[765px] absolute justify-start items-start inline-flex">
        <input class="w-[304px] h-7 pl-2.5 pr-7 bg-white rounded border border-slate-500 flex-col justify-center items-center gap-1.5 inline-flex"></input>
    </div>

    <!--Password Info-->
    <label class="left-[800px] top-[885px] absolute text-black text-base font-normal font-inter leading-9">Password</label>
    <label class="left-[800px] top-[930px] absolute text-black text-base font-normal font-inter leading-9">Confirm Password</label>
    ...
    <div class="left-[1460px] top-[1050px] absolute justify-start items-start gap-2.5 inline-flex">
        ...
        <button type="submit" class="w-32 h-[37.969px] px-4 py-2 bg-indigo-800 rounded-md shadow justify-center items-center gap-2 flex">
            <div class="text-white text-sm font-medium font-inter leading-snug">Save changes</div>
        </button>
    </div>
